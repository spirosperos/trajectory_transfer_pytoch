function tmpreturn = hom_transform_endeffector(q, param)
  ...
  m(2,1) = t31 * (t29 * t47 + t45 * t51) - t33 * (t41 * t47 - t45 * t56);
  m(2,2) = t45 * t72 + t47 * t67;
  m(2,3) = t45 * t95 + t47 * t88;
  m(2,4) = t112 * t47 + t117 * t45;
  t134 = -t27;
  m(3,1) = t31 * (t134 * t22 + t24 * t62) + t33 * (-t10 * t18 * t22 + t24 * t37);
  m(3,2) = t24 * (t20 * t33 + t31 * t37) - (t10 * t18 * t31 + t134 * t33) * t22;
  m(3,3) = t24 * (t10 * t14 * t4 - t77 * t9) + (t10 * t2 * t9 + t4 * t7) * t22;
  t163 = t9 * t2;
  m(3,4) = t22 * (t10 * t163 * t97 + param.d3 + param.d4 + t109) + t24 * (t14 * (-t163 * t7 * t97 + t101 * t10) + t98 * t76) + param.d1 + param.d2;
  m(4,1) = 0.0e0;
  m(4,2) = 0.0e0;
  m(4,3) = 0.0e0;
  m(4,4) = 0.1e1;
